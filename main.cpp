...
bool isSafe(int queen_number, int row_position)
{
        ...
        for(int i=0; i<queen_number; i++)                                            //The queens are on the same when Delta Row == Delta Col
        {                                                                      //Delta Row = other_row_position - row_position
                // Get another queen's row_position                           //Delta Col = queen_number - i
